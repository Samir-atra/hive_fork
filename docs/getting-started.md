...
1. **Validate Your Setup**: Run through the [First Evaluation Walkthrough](./first-evaluation-walkthrough.md)
2. **TUI Dashboard**: Run `hive tui` to explore agents interactively
