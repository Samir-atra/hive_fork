...
api.pulls.update(pull_number=140, title="micro-fix: update storage cache only after successful write — closes #4947")
print("Updated PR title")

api.issues.add_labels(issue_number=140, labels=["micro-fix"])
print("Added label")
