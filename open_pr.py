...
pr = api.pulls.create(
    title="fix: resolve broken __all__ export when optional dependencies missing",
    head="feat/broken-all-export-when-optional-deps-missing-2724",  # Branch in Samir-atra/hive_fork
    base="main",
    body=body,
