...
echo ""
echo -e "  ${BOLD}Option A: Using (Claude Code)${NC}"
echo -e "     ${CYAN}claude${NC} -> ${CYAN}/hive${NC}"
echo ""
echo -e "  ${BOLD}Option B: Manual CLI${NC}"
echo -e "     ${CYAN}cp -r examples/templates/tech_news_reporter exports/my_agent${NC}"
echo -e "     ${CYAN}hive run exports/my_agent${NC}"
echo ""
echo -e "  Test an existing agent:"
