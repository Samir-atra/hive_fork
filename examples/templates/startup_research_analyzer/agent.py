"""Agent graph construction for Startup Research Analyzer."""
...
class StartupResearchAnalyzer:
    """
    Startup Research Analyzer — 4-node pipeline with user checkpoints.
    ...
    def _build_graph(self) -> GraphSpec:
        """Build the GraphSpec."""
        return GraphSpec(
            id="startup-research-analyzer-graph",
    ...
    def _setup(self, mock_mode: bool = False) -> None:
        ...
        self._storage_path = Path.home() / ".hive" / "agents" / "startup_research_analyzer"
...
default_agent = StartupResearchAnalyzer()
