...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/MCP-23_Tools-00ADD8?style=flat-square" alt="MCP" />
</p>
...
- **aden_tools** - 23 MCP tools for agent capabilities
...
├── tools/                  # MCP Tools Package - 23 tools for agent capabilities
...
# - aden_tools package (23 MCP tools)
# - All dependencies
...
Aden includes comprehensive observability features: real-time WebSocket streaming for live agent execution monitoring, TimescaleDB-powered analytics for cost and performance metrics, health check endpoints for Kubernetes integration, and 23 MCP tools for budget management, agent status, and policy control.
